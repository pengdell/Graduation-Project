...
class DataSet(object):
    def __init__(self, fileName, cv):
        ##
        self.data, self.train, self.test, self.shape, self.groundTruth, self.ratedItems  = self.getTrainTestData(fileName, cv)
        self.trainDict = self.getTrainDict()

    def getTrainTestData(self, dataName, cv):
        ...
        return data, train, test, [u, i], groundTruth, ratedItems
